...
import com.example.fassistant.payload.request.LoginRequest;
import com.example.fassistant.payload.request.SignupRequest;
import com.example.fassistant.payload.response.JwtResponse;
import com.example.fassistant.payload.response.MessageResponse;
import com.example.fassistant.repository.RoleRepository;
import com.example.fassistant.repository.UserRepository;
import com.example.fassistant.security.jwt.JwtUtils;
import com.example.fassistant.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		if(signUpRequest.getUsername().isBlank() || signUpRequest.getEmail().isBlank() || signUpRequest.getPassword().isBlank()) {
